...
##Model fitting 
Prior to fitting the desired model, I will split the observations into a train-test ratio of 80/20 to strengthen the predictive power of the model I want to design. Doing so will allow the model to gain higher generalizability to unforeseen data, employing the portion reserved for testing as a real-world proxy.
